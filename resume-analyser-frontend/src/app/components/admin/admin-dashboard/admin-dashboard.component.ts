...
export class AdminDashboardComponent implements OnInit {
  ...
  stats: any = {
    ...
    total_analyses: 0, today_analyses: 0,
    week_analyses: 0, avg_match_score: 0,
    success_rate: 0, users_with_2fa: 0
  };

  statusBreakdown: any = { pending: 0, processing: 0, completed: 0, failed: 0 };
  recentAnalyses: any[] = [];
  weeklyTrend: any[] = [];
  isLoading = true;
    ...
    this.weeklyChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor: '#0A5C6B',
          backgroundColor: 'rgba(10,92,107,0.08)',
          tension: 0.4,
          fill: true,
          pointBackgroundColor: '#0A5C6B',
          pointRadius: 4
        }]
      },
      options: {
    ...
    this.statusChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: ['#1B6E3A', '#0A5C6B', '#C8860A', '#AE1C2D'],
          borderWidth: 2,
          borderColor: '#fff'
        }]
      },
